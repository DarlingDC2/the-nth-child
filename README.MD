...
Beginning code from scratch, the goal is to create a functional website that can be used as a portfoilio by employers.  It uses several different CSS and HTML types.
